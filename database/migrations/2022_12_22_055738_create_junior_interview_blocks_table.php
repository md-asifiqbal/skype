...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('junior_interview_blocks', function (Blueprint $table) {
            $table->comment('');
            $table->increments('id');
            $table->unsignedInteger('junior_interview_id')->index('junior_interview_blocks_junior_interview_id_foreign')->comment('junior_interview_id');
    ...
    {
        Schema::dropIfExists('junior_interview_blocks');
    }
};

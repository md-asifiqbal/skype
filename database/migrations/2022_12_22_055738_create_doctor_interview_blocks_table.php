...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('doctor_interview_blocks', function (Blueprint $table) {
            $table->comment('');
            $table->increments('id');
            $table->unsignedInteger('doctor_interview_id')->index('doctor_interview_blocks_doctor_interview_id_foreign')->comment('doctor_interview_id');
    ...
    {
        Schema::dropIfExists('doctor_interview_blocks');
    }
};
